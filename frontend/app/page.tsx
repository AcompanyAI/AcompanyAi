export default function Home() {
  ...
  <div className="absolute top-1/2 left-1/2 w-[400px] h-[400px] bg-pink-600/10 rounded-full blur-[150px] animate-pulse"></div>
      ...
      {/* Navbar */}
     <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl px-8 py-4 flex items-center justify-between">
  ...
  ">
    AcompanyAI
        ...
        <div className="flex gap-5 items-center">
         ...
         <button className="bg-violet-600 px-6 py-3 rounded-xl shadow-[0_0_30px_rgba(139,92,246,0.8)]">
  Start Free
</button>
        </div>
      </nav>
...
<div className="absolute top-40 right-1/4 text-violet-300 text-2xl animate-ping">
 •
      ...
      <section className="relative flex flex-col items-center justify-center text-center py-32 overflow-hidden">
        ...
        <h1 className="z-10 text-[120px] font-black leading-none tracking-tight">
  ...
  <span className="bg-gradient-to-r from-violet-400 to-blue-400 bg-clip-text text-transparent">
    AI
        ...
        <p className="mt-8 text-gray-400 text-xl max-w-3xl z-10">
          Create stunning posters, logos, banners and more with the power of AI.
        </p>

        <button className="mt-10 px-10 py-4 rounded-2xl bg-violet-600 text-xl font-semibold">
          Start Free
        </button>
